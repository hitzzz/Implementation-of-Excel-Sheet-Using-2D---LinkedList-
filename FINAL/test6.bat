...
if %ERRORLEVEL% GEQ 1 (
	...
	if ERRORLEVEL 0 (
		...
		findstr /R /C:"^4.[0]*,[ 	]*4.[0]*,[	 ]*!CR!!LF!4.5[0]*,[ 	]*5.[0]*,[ 	]*4.[0]*$" temp.txt > NUL
		if ERRORLEVEL 1 (
			echo -----Failed-----
		) else (
			echo +++++Passed+++++
	...
	if ERRORLEVEL 0 (
		findstr /R /C:"^4.[0]*,[ 	]*5.[0]*,[ 	]*4.[0]*!CR!!LF!4.[0]*,[ 	]*5.[0]*,[ 	]*6.[0]*$" temp.txt > NUL
		if ERRORLEVEL 1 (
			echo -----Failed-----
		) else (
			echo +++++Passed+++++
	...
	if ERRORLEVEL 0 (
		findstr /R /C:"^4.[0]*,[ 	,]*!CR!!LF!4.[0]*,[ 	]*5.[0]*,[ 	]*not a number[ 	,]*$" temp.txt > NUL
		if ERRORLEVEL 1 (
			echo -----Failed-----
		) else (
			echo +++++Passed+++++
	...
	if ERRORLEVEL 0 (
		findstr /R /C:"^6.[0]*,[ 	]*5.[0]*,[ 	]*not a number,[ 	]*6.[0]*!CR!!LF!4.[0]*,[ 	]*5.[0]*,[ 	]*6.[0]*,[ 	]*$" temp.txt > NUL
		if ERRORLEVEL 1 (
			echo -----Failed-----
		) else (
			echo +++++Passed+++++
	...
	if ERRORLEVEL 0 (
		findstr /R /C:"^5.[0]*,[ 	]*4.5[0]*,[ 	]*not a number,[ 	]*4.75[0]*!CR!!LF!4.[0]*,[ 	]*5.[0]*,[ 	]*6.[0]*,[ 	]*$" temp.txt > NUL
		if ERRORLEVEL 1 (
			echo -----Failed-----
		) else (
			echo +++++Passed+++++
